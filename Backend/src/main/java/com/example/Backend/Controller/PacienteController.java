...
public class PacienteController {
    ...
    public ResponseEntity<Void> deletePaciente(@PathVariable String rut)throws IOException {
        try {
           ...
           Optional<Paciente> paciente = pacienteService.getPacienteById(rut);
    ...
    @GetMapping ("/{rut}")
    public Optional<Paciente> getPacienteById(@PathVariable String rut) {
        return pacienteService.getPacienteById(rut);
    }
